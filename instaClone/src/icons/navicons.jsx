...
NavIcons.Search = function (props) {
  return props.selected ? (
    <svg
      aria-label="검색"
      fill="currentColor"
...
NavIcons.add = () => {
  return (
    <svg
      aria-label="+ 아이콘"
      class="x1lliihq x1n2onr6 x10xgr34"
      fill="currentColor"
      height="44"
      role="img"
      viewBox="0 0 24 24"
